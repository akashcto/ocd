...
echo "cd /" >> start.sh
echo "java -jar /Services_JAVA_DOCKER/GitPlugin-jar-with-dependencies.jar 172.17.42.1 5555 5557 akashcto 27c02b7623c71b2e7cf7593dc9a0f1425c6dc6f9 22060 / /Services_JAVA_DOCKER/log4j.properties 0.0.0.0 5558 172.17.42.1 7050 https://api.github.com/ &" >> start.sh
echo "java -jar /Services_JAVA_DOCKER/CodeStyle/CodeStyleService-jar-with-dependencies.jar 5566 8899 0.0.0.0 172.17.42.1 /Services_JAVA_DOCKER/CodeStyle/validation_cs.sh 5568 github.com &" >> start.sh
