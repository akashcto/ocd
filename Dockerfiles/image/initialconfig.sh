...
echo "export URL_Maven=https://s3-ap-northeast-1.amazonaws.com/ocd-framework/apache-ant1.9.3-bin.tar.gz" >> /config.sh
echo "export URL_Ant=https://s3-ap-northeast-1.amazonaws.com/ocd-framework/apache-maven-3.1.1-bin.tar.gz" >> /config.sh
