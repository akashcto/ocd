...
default["chef_client"]['config']['chef_server_url']	= "https://172.17.42.1"
default["chef_client"]['config']['validation_client_name']	= "chef-validator"
default["chef_client"]['config']['http_proxy']	= "http://proxy4.wipro.com"
default["chef_client"]['config']['http_proxy_user']	= "gp2272"
default["chef_client"]['config']['http_proxy_pass']	= "india{2020"
